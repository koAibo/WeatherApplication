    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                "CREATE TABLE " + WeatherEntry.TABLE_NAME + " (" +
                        ...
                        /*
                        * To ensure this table can only contain one weather entry per date, date column is declared unique.
                        * Also specify "ON CONFLICT REPLACE". This tells SQLite that if there's another weather entry for a
                        * specific date and an attempt to insert one is made, the old weather entry is replaced.
                        */
